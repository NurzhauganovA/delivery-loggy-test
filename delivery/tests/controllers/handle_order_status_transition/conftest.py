...
@pytest.fixture
def handlers() -> OrderStatusTransitionHandlers:
    return {
        OrderStatusCodes.CARD_RETURNED_TO_BANK: CardReturnedToBankHandler(),
        OrderStatusCodes.POS_TERMINAL_REGISTRATION: AsyncMock()
    }


@pytest.fixture
def controller(handlers: OrderStatusTransitionHandlers) -> OrderStatusTransitionController:
    return OrderStatusTransitionController(
        handlers=handlers,
    )
...
def delivery_graphs_insert_script() -> str:
    return """
        ...
        VALUES (1, '[{"id": 1,"status": "new","icon": "order_new","slug": "novaia-zaiavka","name_en": "New order","name_ru": "Новая заявка","position": 1,"button_name": null,"transitions": [{"trigger": "courier_assigned","source": "new","dest": "courier_assigned"},{"trigger": "card_returned_to_bank","source": "new","dest": "card_returned_to_bank"}]},{"id": 2,"status": "courier_assigned","icon": "courier_appointed","slug": "kurer-naznachen","name_en": "Courier appointed","name_ru": "Курьер назначен","position": 2,"button_name": "Принять в работу","transitions": [{"trigger": "in_way","source": "courier_assigned","dest": "in_way"},{"trigger": "card_returned_to_bank","source": "courier_assigned","dest": "card_returned_to_bank"}]},{"id": 3,"status": "in_way","icon": "courier_accepted","slug": "priniato-kurerom-v-rabotu","name_en": "Courier accepted","name_ru": "Принято курьером в работу","position": 3,"button_name": "К клиенту","transitions": [{"trigger": "at_client","source": "in_way","dest": "at_client"},{"trigger": "card_returned_to_bank","source": "in_way","dest": "card_returned_to_bank"}]},{"id": 25,"status": "at_client","icon": "at_client","slug": "u-klienta","name_en": "At client","name_ru": "У клиента","position": 4,"button_name": "Отправить SMS с кодом","transitions": [{"trigger": "otp_sent","source": "at_client","dest": "otp_sent"},{"trigger": "card_returned_to_bank","source": "at_client","dest": "card_returned_to_bank"}]},{"id": 20,"status": "otp_sent","icon": "post_control","slug": "kod-otpravlen","name_en": "OTP sent","name_ru": "Код отправлен","position": 5,"button_name": "Проверить код","transitions": [{"trigger": "photo_capturing","source": "otp_sent","dest": "photo_capturing"},{"trigger": "card_returned_to_bank","source": "otp_sent","dest": "card_returned_to_bank"}]},{"id": 16,"status": "photo_capturing","icon": "post_control","slug": "fotografirovanie","name_en": "Photo capturing","name_ru": "Фотографирование","position": 7,"button_name": "Отправить на последконтроль","transitions": [{"trigger": "post_control","source": "photo_capturing","dest": "post_control"},{"trigger": "card_returned_to_bank","source": "photo_capturing","dest": "card_returned_to_bank"}]},{"id": 12,"status": "post_control","icon": "post_control","slug": "posledkontrol","name_en": "Postcontrol","name_ru": "Последконтроль","position": 8,"button_name": null,"transitions": [{"trigger": "delivered","source": "post_control","dest": "delivered"},{"trigger": "card_returned_to_bank","source": "post_control","dest": "card_returned_to_bank"}]},{"id": 7,"status": "delivered","icon": "order_delivered","slug": "dostavleno","name_en": "Delivered","name_ru": "Доставлено","position": 9,"button_name": null},{"id": 35,"status": "card_returned_to_bank","icon": "card_returned_to_bank","slug": "card-returned-to-bank","name_en": "Card was returned to bank","name_ru": "Карта возвращена в банк","position": null,"button_name": null,"transitions": [{"trigger": "new","source": "card_returned_to_bank","dest": "new"}]}]', null, 'Базовый', null, '{urgent,operative,planned}', '[{"id": 1, "icon": "order_new", "name": "Новая заявка", "slug": "novaia-zaiavka", "position": 1, "button_name": null}, {"id": 2, "icon": "courier_appointed", "name": "Курьер назначен", "slug": "kurer-naznachen", "position": 2, "button_name": "Принять в работу"}, {"id": 3, "icon": "courier_accepted", "name": "Принято курьером в работу", "slug": "priniato-kurerom-v-rabotu", "position": 3, "button_name": "К точке доставки"}, {"id": 4, "icon": "otw_delivery_point", "name": "В пути к точке доставки", "slug": "v-puti-k-tochke-dostavki", "position": 4, "button_name": "На точке доставки"}, {"id": 5, "icon": "on_delivery_point", "name": "На точке доставки", "slug": "na-tochke-dostavki", "position": 5, "button_name": "Контакт с получателем"}, {"id": 6, "icon": "at_client", "name": "Контакт с получателем", "slug": "kontakt-s-poluchatelem", "position": 6, "button_name": "Посылка передана"}, {"id": 7, "icon": "order_delivered", "name": "Доставлено", "slug": "dostavleno", "position": 7, "button_name": null}]', null, null, null);
        
        INSERT INTO public.deliverygraph (id, graph, partner_id, name_ru, slug, types, graph_courier, name_en, name_zh, name_kk) 
        VALUES (2, '[{"id": 1,"icon": "order_new","slug": "novaia-zaiavka","status": "new","name_en": "New order","name_ru": "Новая заявка","position": 1,"button_name": null,"transitions": [{"dest": "courier_assigned","source": "new","trigger": "courier_assigned"}]},{"id": 2,"icon": "courier_appointed","slug": "kurer-naznachen","status": "courier_assigned","name_en": "Courier appointed","name_ru": "Курьер назначен","position": 2,"button_name": "Принять в работу","transitions": [{"dest": "in_way","source": "courier_assigned","trigger": "in_way"}]},{"id": 3,"icon": "courier_accepted","slug": "priniato-kurerom-v-rabotu","status": "in_way","name_en": "Courier accepted","name_ru": "Принято курьером в работу","position": 3,"button_name": "Принято курьером в работу","transitions": [{"dest": "pos_terminal_registration","source": "in_way","trigger": "pos_terminal_registration"}]},{"id": 36,"icon": "pos_terminal_registration","slug": "vvod-seriynogo-nomera-i-modeli","status": "pos_terminal_registration","name_en": "Enter serial number and model","name_ru": "Ввод серийного номера и модели","position": 4,"button_name": "Продолжить","transitions": [{"dest": "send_otp","source": "pos_terminal_registration","trigger": "send_otp"}]},{"id": 25,"icon": "at_client","slug": "u-klienta","status": "send_otp","name_en": "Send OTP","name_ru": "Отправка OTP","position": 5,"button_name": "Отправить SMS с кодом","transitions": [{"dest": "verify_otp","source": "send_otp","trigger": "verify_otp"}]},{"id": 20,"icon": "post_control","slug": "kod-otpravlen","status": "verify_otp","name_en": "Verify OTP","name_ru": "Верификация ОТР","position": 6,"button_name": "Проверить код","transitions": [{"dest": "photo_capturing","source": "verify_otp","trigger": "photo_capturing"}]},{"id": 16,"icon": "post_control","slug": "fotografirovanie","status": "photo_capturing","name_en": "Photo capturing","name_ru": "Фотографирование","position": 7,"button_name": "Отправить на последконтроль","transitions": [{"dest": "post_control","source": "photo_capturing","trigger": "post_control"}]},{"id": 12,"icon": "post_control","slug": "posledkontrol","status": "post_control","name_en": "Postcontrol","name_ru": "Последконтроль","position": 8,"button_name": null,"transitions": [{"dest": "delivered","source": "post_control","trigger": "delivered"}]},{"id": 7,"status": "delivered","icon": "order_delivered","name_ru": "Доставлено","name_en": "Delivered","slug": "dostavleno","position": 9,"button_name": null}]', null, 'Базовый', null, '{urgent,operative,planned}', '[{"id": 1,"icon": "order_new","slug": "novaia-zaiavka","status": "new","name_en": "New order","name_ru": "Новая заявка","position": 1,"button_name": null,"transitions": [{"dest": "courier_assigned","source": "new","trigger": "courier_assigned"}]},{"id": 2,"icon": "courier_appointed","slug": "kurer-naznachen","status": "courier_assigned","name_en": "Courier appointed","name_ru": "Курьер назначен","position": 2,"button_name": "Принять в работу","transitions": [{"dest": "in_way","source": "courier_assigned","trigger": "in_way"}]},{"id": 3,"icon": "courier_accepted","slug": "priniato-kurerom-v-rabotu","status": "in_way","name_en": "Courier accepted","name_ru": "Принято курьером в работу","position": 3,"button_name": "Принято курьером в работу","transitions": [{"dest": "pos_terminal_registration","source": "in_way","trigger": "pos_terminal_registration"}]},{"id": 36,"icon": "pos_terminal_registration","slug": "vvod-seriynogo-nomera-i-modeli","status": "pos_terminal_registration","name_en": "Enter serial number and model","name_ru": "Ввод серийного номера и модели","position": 4,"button_name": "Продолжить","transitions": [{"dest": "send_otp","source": "pos_terminal_registration","trigger": "send_otp"}]},{"id": 25,"icon": "at_client","slug": "u-klienta","status": "send_otp","name_en": "Send OTP","name_ru": "Отправка OTP","position": 5,"button_name": "Отправить SMS с кодом","transitions": [{"dest": "verify_otp","source": "send_otp","trigger": "verify_otp"}]},{"id": 20,"icon": "post_control","slug": "kod-otpravlen","status": "verify_otp","name_en": "Verify OTP","name_ru": "Верификация ОТР","position": 6,"button_name": "Проверить код","transitions": [{"dest": "photo_capturing","source": "verify_otp","trigger": "photo_capturing"}]},{"id": 16,"icon": "post_control","slug": "fotografirovanie","status": "photo_capturing","name_en": "Photo capturing","name_ru": "Фотографирование","position": 7,"button_name": "Отправить на последконтроль","transitions": [{"dest": "post_control","source": "photo_capturing","trigger": "post_control"}]},{"id": 12,"icon": "post_control","slug": "posledkontrol","status": "post_control","name_en": "Postcontrol","name_ru": "Последконтроль","position": 8,"button_name": null,"transitions": [{"dest": "delivered","source": "post_control","trigger": "delivered"}]},{"id": 7,"status": "delivered","icon": "order_delivered","name_ru": "Доставлено","name_en": "Delivered","slug": "dostavleno","position": 9,"button_name": null}]', null, null, null);
    """
...
def orders_insert_script() -> str:
    ...
    INSERT INTO public."order" (id, type, created_at, delivery_datetime, delivery_status, receiver_name, receiver_iin, receiver_phone_number, comment, city_id, courier_id, item_id, partner_id, partner_order_id, main_order_id, position, area_id, archived, created_by, deliverygraph_id, callbacks, initial_delivery_datetime, order_group_id, revised, allow_courier_assign, actual_delivery_datetime, current_status_id, shipment_point_id, delivery_point_id) 
    VALUES (3, 'planned', '2024-02-08 06:11:17.160374 +00:00', '2024-02-20 23:59:00.000000 +00:00', '{"status": "is_delivered"}', 'МАТАШЕВ АКБАР МУСЛИМЖАНОВИЧ', '860824302113', '+77781254616', '', 1, 1, 1, 1, null, null, null, 1, false, 'integration', 2, '{"set_otp": "https://business.bankffin.kz/api/loggy/callbacks/set-otp/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02", "set_pan": null, "set_status": "https://business.bankffin.kz/api/loggy/callbacks/set-status/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02"}', null, null, false, true, '2024-02-20 11:21:50.279633 +00:00', 36, null, 1);
    """
