...
from api.adapters.freedom_bank_otp.adapter import FreedomBankOTPAdapter
from api.adapters.freedom_bank_otp.protocols import FreedomBankOTPProtocol
from api.adapters.pos_terminal_otp import PosTerminalOTPAdapter
from api.adapters.pos_terminal_otp.protocols import PosTerminalOTPClientProtocol
...
@pytest.fixture
def pos_terminal_otp_client():
    return AsyncMock()


@pytest.fixture
def freedom_bank_otp_client():
    return AsyncMock()


@pytest.fixture
def pos_terminal_otp_adapter(
    pos_terminal_otp_client: PosTerminalOTPClientProtocol,
) -> PosTerminalVerifyOTPProtocol:
    adapter = PosTerminalOTPAdapter(
        client=pos_terminal_otp_client,
    )
...
@pytest.fixture
def freedom_bank_otp_adapter(
    freedom_bank_otp_client: FreedomBankOTPProtocol,
) -> FreedomBankVerifyOTPProtocol:
    adapter = FreedomBankOTPAdapter(
        client=freedom_bank_otp_client,
    )
    adapter.verify = AsyncMock()
    return adapter
...
@pytest.fixture
def handler(
        pos_terminal_otp_adapter: PosTerminalVerifyOTPProtocol,
        freedom_bank_otp_client: FreedomBankVerifyOTPProtocol,
) -> VerifyOTPHandler:
    return VerifyOTPHandler(
        verify_otp_adapters={
            1: freedom_bank_otp_client,
...
def orders_insert_script() -> str:
    ...
    VALUES (1, 'planned', '2024-02-08 06:11:17.160374 +00:00', '2024-02-20 23:59:00.000000 +00:00', '{"status": "is_delivered"}', 'МАТАШЕВ АКБАР МУСЛИМЖАНОВИЧ', '860824302113', '+77781254616', '', 1, 1, 1, 1, 'BFF000081', null, null, 1, false, 'integration', 1, '{"set_otp": "https://business.bankffin.kz/api/loggy/callbacks/set-otp/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02", "set_pan": null, "set_status": "https://business.bankffin.kz/api/loggy/callbacks/set-status/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02"}', null, null, false, true, '2024-02-20 11:21:50.279633 +00:00', 1, null, 1);
    INSERT INTO public."order" (id, type, created_at, delivery_datetime, delivery_status, receiver_name, receiver_iin, receiver_phone_number, comment, city_id, courier_id, item_id, partner_id, partner_order_id, main_order_id, position, area_id, archived, created_by, deliverygraph_id, callbacks, initial_delivery_datetime, order_group_id, revised, allow_courier_assign, actual_delivery_datetime, current_status_id, shipment_point_id, delivery_point_id) 
    VALUES (2, 'planned', '2024-02-08 06:11:17.160374 +00:00', '2024-02-20 23:59:00.000000 +00:00', '{"status": "is_delivered"}', 'МАТАШЕВ АКБАР МУСЛИМЖАНОВИЧ', '860824302113', '+77781254616', '', 1, 1, 1, 2, null, null, null, 1, false, 'integration', 1, '{"set_otp": "https://business.bankffin.kz/api/loggy/callbacks/set-otp/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02", "set_pan": null, "set_status": "https://business.bankffin.kz/api/loggy/callbacks/set-status/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02"}', null, null, false, true, '2024-02-20 11:21:50.279633 +00:00', 1, null, 1);
    """
...
def geolocation_insert_script() -> str:
    return """
        INSERT INTO public.order_geolocations (at_client_point, code_sent_point, order_id, updated_at, courier_id, speed, distance, created_at) 
        VALUES ('{43.21240810,76.79422830}', null, 2, '2025-05-05 10:40:42.432400 +00:00', 1, 0.00, 0.000, '2025-05-05 15:40:41.116739 +00:00');
    """
