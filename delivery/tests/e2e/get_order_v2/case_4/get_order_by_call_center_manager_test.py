...
@pytest.mark.asyncio
async def test_get_order_by_call_center_manager(
    client,
    credentials,
    profile_data,
    get_access_token_v1,
...
@pytest.mark.asyncio
async def test_get_order_by_call_center_manager_not_found(
    client,
    credentials,
    profile_data,
    get_access_token_v1,
    ...
    """
    Try to get an order with an unrelated city_id to the call_center_manager.
    """
    await run_pre_start_sql_script(pre_start_sql_script)
