...
@pytest.mark.asyncio
async def test_get_item_by_supervisor(
        client,
        credentials,
        profile_data,
        get_access_token_v1,
...
@pytest.mark.asyncio
async def test_get_item_by_supervisor_empty_result(
        client,
        credentials,
        profile_data,
        get_access_token_v1,
    ...
    """
        Attempt to get an item with unmatched cities of the country of the supervisor.
    """
    await run_pre_start_sql_script(pre_start_sql_script)
