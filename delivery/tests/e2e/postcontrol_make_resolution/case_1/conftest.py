...
def postcontrol_config_insert_script() -> str:
    ...
    INSERT INTO "public"."postcontrol_configs"
      ("id", "item_id", "name", "send", "document_code", "parent_config_id")
    VALUES
      (1, 1, 'id card', true, 'PASSPORT_PHOTO', null),
      (2, 1, 'front side', true, 'PASSPORT_PHOTO', 1),
      (3, 1, 'back side', true, 'PASSPORT_PHOTO', 1),
      (4, 1, 'selfie', true, 'USER_PHOTO', null)
    ;
    """
