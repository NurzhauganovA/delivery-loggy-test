        ...
        'items': [
            {
                ...
                'current_status': {'icon': 'order_delivevred',
                                   'id': 7,
                                   'name': None,
                                   'slug': 'dostavleno'},
                'current_status_position': 7,
                'delivery_datetime': '2024-02-20T23:59:00+00:00',
                'delivery_point': {'address': 'Казахстан, Алматы, Алматы, '
            ...
            {
                'area': None,
                'city': {'id': 4, 'name': 'Moscow', 'timezone': 'Europe/Moscow'},
                'comment': '',
                'courier': None,
...
def pre_start_sql_script() -> str:
    ...
    scripts = [
        ...
        profile_general_call_center_manager_insert_script(),
...
def profile_general_call_center_manager_insert_script() -> str:
    return """
           INSERT INTO public.profile_general_call_center_manager (id, user_id, partner_id)
           VALUES (1, 1, 1);
           """
...
def groups_users_insert_script() -> str:
    return """
           ...
           VALUES (1, 'general_call_center_manager', 1);
           """
