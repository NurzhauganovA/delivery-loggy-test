...
def img_png(request):
    ...
    with open(f'{current_dir}/fixtures/img.png', 'rb') as file:
...
def users_insert_script() -> str:
    ...
    return """
           ...
           VALUES (1, '+77777777777', 'Служба 1', 'Службаева 1', 'Службаевна 1', null, null, true, '', null,
...
def order_comments_insert_script() -> str:
    return """
    INSERT INTO public.order_comment ("id", "text", "order_id", "user_id", "user_name", "user_role_id", "created_at")
    VALUES
        (1, 'Sample comment text', 1, 1, 'Службаева 1 Служба 1 Службаевна 1', 'service_manager', '2025-04-14T12:00:00+00:00')
    ;
    """
