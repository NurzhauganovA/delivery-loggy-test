...
@pytest.mark.asyncio
@patch('api.services.sms.notification.send_message_to_notification_service', new=AsyncMock(return_value=None))
async def test_create_logist_with_existing_user(
        client,
        credentials,
        profile_data,
        get_access_token_v1,
...
@pytest.mark.asyncio
@patch('api.services.sms.notification.send_message_to_notification_service', new=AsyncMock(return_value=None))
async def test_create_logist_with_invalid_country_id(
        client,
        credentials,
        profile_data,
        get_access_token_v1,
...
@pytest.mark.asyncio
@patch('api.services.sms.notification.send_message_to_notification_service', new=AsyncMock(return_value=None))
async def test_create_logist_with_invalid_partner_id(
        client,
        credentials,
        profile_data,
        get_access_token_v1,
