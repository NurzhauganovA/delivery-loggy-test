...
def pre_start_sql_script() -> str:
    ...
    scripts = [
        ...
        order_sms_postcontrols_insert_script(),
    ]
...
def profile_couriers_insert_script() -> str:
    return """
        ...
        VALUES (1, false, null, null, null, null, '{monday}', '2023-05-12 07:23:44.928687 +00:00', true, false, null, null, 'car', 1, 2, null, 100, 'accepted', null, false);
    """
...
def orders_insert_script() -> str:
    ...
    VALUES (1, 'planned', '2024-02-08 06:11:17.160374 +00:00', '2024-02-20 23:59:00.000000 +00:00', '{"status": "is_delivered"}', 'МАТАШЕВ АКБАР МУСЛИМЖАНОВИЧ', '860824302113', '+77781254616', '', 1, 1, 1, 100, null, null, null, 1, false, 'integration', 1, '{"set_otp": "https://business.bankffin.kz/api/loggy/callbacks/set-otp/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02", "set_pan": null, "set_status": "https://business.bankffin.kz/api/loggy/callbacks/set-status/3928b9e9-91a5-481c-88d2-9980a3f75f10?token=f0ce3fd77de24e0a9b07e7a02da2aa02"}', null, null, false, true, '2024-02-20 11:21:50.279633 +00:00', 7, null, 1);
    """

def order_sms_postcontrols_insert_script() -> str:
    return """
    INSERT INTO public.order_sms_postcontrols (otp, created_at, try_count, accepted_at, order_id) 
    VALUES (1111, '2025-05-05 15:49:56.494394 +00:00', 0, '2025-05-05 15:50:02.126773 +00:00', 1);
    """
