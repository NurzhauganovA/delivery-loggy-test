...
def expected() -> dict:
    return {
        'addresses': [{'id': 1,
                       'place': {'address': 'Казахстан, Алматы, Алматы, Микрорайон '
                                            'Каргалы, д.25',
                                 'city_id': None,
                                 'id': 1,
                                 'latitude': 43.165452,
        ...
        'courier': None,
        'courier_id': None,
        'created_at': '2025-04-14T12:00:00+00:00',
        'created_by': 'integration',
        'current_status_id': 2,
        'delivery_datetime': '2025-04-14T12:00:00+00:00',
        'delivery_point_id': 1,
        'delivery_status': {
            'comment': None,
            'datetime': None,
        ...
        'item': {'accepted_delivery_statuses': None,
        ...
        'order_group_id': None,
        'product': None,
        'partner': {'article': 'ОB', 'courier_partner_id': 1, 'id': 3, 'name': 'Партнер 2'},
        'partner_id': 3,
        ...
        'statuses': [
            ...
            {
                'created_at': '2025-04-14T12:00:01+00:00',
                'status': {
                    'icon': 'courier_appointed',
                    'id': 2,
                    'name': None,
