...
def orders_insert_script() -> str:
    return """
           ...
           VALUES (1, 'planned', '2025-04-14T12:00:00+00:00', '2025-04-14T12:00:00+00:00',
                   '{"status": null}', 'МАТАШЕВ АКБАР МУСЛИМЖАНОВИЧ', '860824302113', '+77781254616', '', 1,
                   1, 3, null, null, null, false, 'integration', 1,
                   '{"set_otp": "https://partner-sample.kz/send-otp?api-key=something&orderId=sdfl", "set_pan": "https://partner-sample.kz/send-otp?api-key=something&orderId=sdfl", "set_status": "https://partner-sample.kz/send-otp?api-key=something&orderId=sdfl"}',
                   null, null, false, true, '2024-02-20 11:21:50.279633 +00:00', 2, null, 1),
                   (2, 'planned', '2025-04-14T12:00:00+00:00', '2025-04-14T12:00:00+00:00',
                   '{"status": null}', 'МАТАШЕВ АКБАР МУСЛИМЖАНОВИЧ', '860824302113', '+77781254616', '', 1,
                   1, 3, null, null, null, false, 'integration', 1,
                   '{"set_otp": "https://partner-sample.kz/send-otp?api-key=something&orderId=sdflasdf", "set_pan": "https://partner-sample.kz/send-otp?api-key=something&orderId=sdflasdf", "set_status": "https://partner-sample.kz/send-otp?api-key=something&orderId=sdflasdf"}',
                   null, null, false, true, '2024-02-20 11:21:50.279633 +00:00', 1, null, 1);
           """
...
def order_statuses_insert_script() -> str:
    ...
    VALUES
     ...
     (3, 1, 2, '2025-04-14T12:00:00+00:00');
    """
